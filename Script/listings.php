...
if (isset($_GET['search']) && isset($_GET['fuel']) && isset($_GET['keyword']) && $_GET['search'] == "✓") {
...
try {
    ...
    foreach($result as $row)
    {
		...
		print ' value="'.$row['fuel'].'">'.$row['fuel'].'</option>';
	}
...
<span>
<a><i class="lni-map-marker"></i> <?php echo $row['fuel']; ?></a>
</span>
...
<div class="widget">
<div class="footer-logo"><h3 class="block-title">About Us</h3></div>
